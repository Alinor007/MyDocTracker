...
namespace DocumentTrackerWebApi.Migrations
{
    ...
    public partial class dbinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentApprovals_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DocumentApprovalId = table.Column<int>(type: "int", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Histories_DocumentApprovals_DocumentApprovalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentApprovals_OfficeId",
                table: "DocumentApprovals",
                column: "OfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_DocumentApprovalId",
                table: "Histories",
                column: "DocumentApprovalId");
